...
当前无设计阻塞。S08 代码验证、双工程 Build、Flash Layout、RTT、CmBacktrace、向量拒绝、合法 Jump 和 GDB Runtime Snapshot 已通过；待 Project Owner 补齐真实断电上电、LED/LCD 现场行为和一个 Application 外设中断路径后进入 Review。
