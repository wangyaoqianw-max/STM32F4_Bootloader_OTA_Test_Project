 ...
 * @brief Firmware Metadata V1 公共接口
 * @author YaoQian Wang
 * @date 2026-09-13
 * @version V1.0
 *
...
/**
 * @brief Firmware Metadata V1 的内存表达
...
typedef struct
{
    ...
    uint32_t sequence;
    /** 系统当前选择的活动 Slot；可为 FIRMWARE_SLOT_NONE。 */
...
//******************************** Declaring *******************************//
/**
 * @brief 编码尚未提交的 Metadata V1 副本
 * @param[in] metadata : 源 Metadata；不得为空，全部字段必须符合 V1 范围
...
/**
 * @brief 验证并解码已提交的 Metadata V1 副本
